...
return [
    ...
    */
    'generator'  => [
//        'basePath'      => app_path(),
        'basePath'      => base_path('packages/erpnet-models/src/v1'),
        'rootNamespace' => 'ErpNET\\Models\\v1\\',
        'paths'         => [
            'models'       => 'Entities',
            ...
            'provider'     => 'ErpnetModelsServiceProvider',
            'criteria'     => 'Criteria',
//            'stubsOverridePath' => app_path()
            'stubsOverridePath' => base_path('packages/erpnet-models/src/v1')
        ]
    ]
];
